...
export default function AdminPanelBlock({ blockTitle, children }: Props) {
	return (
		<div className="w-3/4 flex flex-col gap-[10px] max-sm:w-full">
			...
			<div className="h-[200px] overflow-x-hidden overflow-y-scroll border-black border-[2px] p-4 flex flex-col gap-[10px] max-sm:h-[300px] dark:bg-white dark:text-black">
				{children}
			</div>
		</div>
	);
